...
const mockUseMusicPlayerStore = useMusicPlayerStore as jest.MockedFunction<typeof useMusicPlayerStore>;
...
describe('SettingsScreen Integration Tests', () => {
    ...
    describe('Server Configuration', () => {
        test('should render server configuration form with existing values', () => {
            ...
            expect(screen.getByDisplayValue('https://demo.subsonic.org')).toBeTruthy();
        ...
        test('should test connection and save configuration', async () => {
            ...
            const serverUrlInput = screen.getByPlaceholderText('https://your-server.com/subsonic');
        ...
        test('should clear error when input changes', () => {
            ...
            const serverUrlInput = screen.getByDisplayValue('https://demo.subsonic.org');
    ...
    describe('Offline Mode Settings', () => {
        ...
        test('should show warning when offline and no internet connection', () => {
            ...
            expect(screen.getByText(/Offline mode automatically enabled/)).toBeTruthy();
        });
    ...
    describe('State Synchronization', () => {
        ...
        test('should handle missing config gracefully', () => {
            ...
            expect(screen.getByPlaceholderText('https://your-server.com/subsonic')).toBeTruthy();

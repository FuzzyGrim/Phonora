...
describe('HomeScreen Integration Tests', () => {
    ...
    describe('Offline Mode', () => {
        ...
        it('should show network banner when not connected', () => {
            ...
            expect(getByText('No internet connection. Offline mode enabled automatically.')).toBeTruthy();
        });
        ...
        it('should show empty state message for offline mode when no cached songs', () => {
            ...
            expect(getByText('No cached songs available for offline playback')).toBeTruthy();
            expect(getByText('Connect to the internet to browse and cache music')).toBeTruthy();
        });
    });

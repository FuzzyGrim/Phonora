...
describe('MiniPlayer Integration Tests', () => {
    ...
    describe('Song Information Display', () => {
        ...
        test('should truncate long song titles', () => {
            ...
            expect(screen.getByText('This is a very long song title that should be truncated')).toBeTruthy();
            expect(screen.getByText('This is also a very long artist name that should be truncated')).toBeTruthy();
        });
    });

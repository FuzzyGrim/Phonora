...
import { Song, SearchResults, Album, Artist, Genre, Playlist } from '../../store/types';
...
describe('API Slice', () => {
    ...
    const mockGenerateAuthParams = jest.fn(() => new URLSearchParams({
        u: 'testuser',
        t: 'token123',
        s: 'salt123',
        v: '1.16.1',
    ...
    describe('fetchAlbums', () => {
        ...
        it('should throw error when no config', async () => {
            ...
            await expect(apiSlice.fetchAlbums()).rejects.toThrow('Server configuration is missing');
        });
        ...
        it('should handle API errors', async () => {
            ...
            await expect(apiSlice.fetchAlbums()).rejects.toThrow('Failed to fetch albums');
        });
    });
